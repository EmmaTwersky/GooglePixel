(function(root) {
    ...
    function Pixeled(image, opts) {
      ...
      var imageLoaded = function() {
        ...
        this.canvas.style.cssText = 'image-rendering: optimizeSpeed;' + // FireFox < 6.0
                           ...
                           'image-rendering: Pixeledd; ' + // Future browsers
    ...
    Pixeled.prototype.setAmount = function(amount) {
      this.amount = 1 - (amount || 0);
      return this;
    };
  
    Pixeled.prototype.setWidth = function(width) {
    ...
    Pixeled.prototype.render = function() {
    ...
    if (typeof exports !== 'undefined') {
      if (typeof module !== 'undefined' && module.exports) {
        exports = module.exports = Pixeled;
      }
      exports.Pixeled = Pixeled;
    } else if (typeof define === 'function' && define.amd) {
      define([], function() {
        return Pixeled;
      });
    } else {
      root.Pixeled = Pixeled;
    }
